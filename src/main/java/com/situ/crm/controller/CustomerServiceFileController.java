...
import com.situ.crm.service.ICustomerServiceFileService;
import com.situ.crm.service.IUserService;

@Controller
@RequestMapping("/customerServiceFile")
public class CustomerServiceFileController {
	...
	public ServerResponse delete(String ids) {
		return customerServiceFileService.delete(ids);
	}
	
	@RequestMapping("/update")
	@ResponseBody
	public ServerResponse update(CustomerService customerService) {
		return customerServiceFileService.update(customerService);
	}
	
	@RequestMapping(value="/add")
	@ResponseBody
	public ServerResponse add(CustomerService customerService){
		return customerServiceFileService.add(customerService);
	}
	...
	public EasyUIDataGrideResult findAll(Integer page, Integer rows, CustomerService customerService,Date beginTime, Date endTime){
		return customerServiceFileService.findAll(page, rows, customerService, beginTime, endTime);
	}
